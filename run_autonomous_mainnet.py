...
def run_autonomous_mainnet_agent():
    ...
    try:
        ...
        print(f"   Macro Short: $10.90 WETH → USDT collateral (target $10 profit)")
        print(f"   Micro Short: $7.20 WETH → USDT collateral (target $10 profit)")
        print(f"   Short Flow: Borrow WETH → Swap USDT → Supply → Hunt → Close → Repay")
