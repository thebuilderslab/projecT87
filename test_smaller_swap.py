#!/usr/bin/env python3
"""
Test debt swap with smaller amount (5 DAI) to avoid health factor violation
"""
...
def main():
    ...
    print("=" * 80)
    print("SMALLER AMOUNT DEBT SWAP TEST (5 DAI → WETH)")
    print("=" * 80)
    ...
    # Try smaller amount to avoid health factor violation
    print("\n" + "=" * 80)
    print("SWAP TEST: 5 DAI → WETH (REDUCED AMOUNT)")
    print("=" * 80)
    print("📊 Action: Repay 5 DAI debt, borrow WETH")
    print("💡 Smaller amount to keep health factor safe\n")
