...
def wallet_status():
    ...
    try:
        ...
        if hasattr(agent, 'aave'):
            ...
            try:
                    # PRIORITY: Try enhanced direct Aave contract calls for mainnet
...
@app.route('/api/debug/mainnet-aave')
def debug_mainnet_aave():
    ...
    try:
        ...
        debug_response = {
            ...
            'network_info': {
                ...
                'network_mode': network_mode,
                'wallet_address': agent.address,
                'expected_mainnet': chain_id == 42161
            },
            'aave_data': aave_data,
            'aave_pool_address': "0x794a61358D6845594F94dc1DB02A252b5b4814aD",
            'debug_status': {
                'agent_initialized': True,
                'aave_data_retrieved': aave_data is not None,
